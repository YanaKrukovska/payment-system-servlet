...
create index PAYMENT_BALANCE_INDEX on accounts (balance);
alter table credit_cards
    add constraint CARD_NUMBER_UNIQUE_CONSTRAINT unique (card_number);
create index PAYMENT_DATE_INDEX on payments (payment_date);
create index PAYMENT_ACCOUNT_INDEX on payments (account_id);
alter table users
